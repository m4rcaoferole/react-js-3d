    ...
    <Tilt className="xs:w-[250px] w-full">
      ...
      >
        ...
        >
          ...
          <h3 className="text-white tex-[20x] font-bold text-center">{title}</h3>
        </div>
      </motion.div>
    </Tilt>
  );
  ...
  return (
    <>
      ...
      >
        ...
        expertise in frameworks like React, Node.js, and Next.js, I'm a quick learner and
        collaborate closely with clients to create efficient, scalable, and user-friendly
        solutions that solve real-world problems. let's work together to bring you ideas
        to life!
      </motion.p>
